...
void OmniDriveController::updateJointReferences()
{
  ...
  setJointPositionReferenceWithLessChange(q[1], a[1], joint_states_mean_[FRONT_LEFT_TRACTION_JOINT],
                                          joint_references_[FRONT_LEFT_DIRECTION_JOINT]);
  setJointPositionReferenceWithLessChange(q[2], a[2], joint_states_mean_[BACK_LEFT_TRACTION_JOINT],
                                          joint_references_[BACK_LEFT_DIRECTION_JOINT]);
  setJointPositionReferenceWithLessChange(q[3], a[3], joint_states_mean_[BACK_RIGHT_TRACTION_JOINT],
                                          joint_references_[BACK_RIGHT_DIRECTION_JOINT]);
  ...
  all_references_are_between_limits &=
      checkJointPositionReferenceIsBetweenMotorWheelLimits(a[1], range_limit, FRONT_LEFT_DIRECTION_JOINT);
  all_references_are_between_limits &=
      checkJointPositionReferenceIsBetweenMotorWheelLimits(a[2], range_limit, BACK_LEFT_DIRECTION_JOINT);
  all_references_are_between_limits &=
      checkJointPositionReferenceIsBetweenMotorWheelLimits(a[3], range_limit, BACK_RIGHT_DIRECTION_JOINT);
...
void OmniDriveController::setJointPositionReferenceWithLessChange(double& wheel_speed, double& wheel_angle,
...
void OmniDriveController::setJointPositionReferenceBetweenMotorWheelLimits(double& wheel_speed, double& wheel_angle,
                                                                           int joint_number)
{
...
bool OmniDriveController::checkJointPositionReferenceIsBetweenMotorWheelLimits(double wheel_angle, double range,
                                                                               int joint_number)
{
  double lower_limit = joint_limits_[joint_number].first;
  double upper_limit = joint_limits_[joint_number].second;
